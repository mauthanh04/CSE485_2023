        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="../app/views/login_views.php">Đăng nhập</a>
                    </li>
                </ul>

                <!-- gộp file seaech -->
                <?php require_once('../app/controllers/search_index_controllers.php'); ?>
        ...
        <div class="row">
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../app/views/detail.php" class="text-decoration-none">Cây, lá và gió</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../app/views/detail2.php" class="text-decoration-none">Cuộc sống mến thương</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../app/views/detail3.php" class="text-decoration-none">Lòng mẹ</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../app/views/detail4.php" class="text-decoration-none">Phôi pha</a>
                        </h5>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
                            <a href="../app/views/detail5.php" class="text-decoration-none">Nơi tình yêu bắt đầu</a>
                        </h5>
                    </div>
                </div>
            </div>

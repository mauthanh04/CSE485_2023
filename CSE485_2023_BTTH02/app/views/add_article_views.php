...
<?php require_once('../controllers/add_article_controllers.php'); ?>
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                ...
                <form action="../views/add_article_views.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group  float-end ">
                        ...
                        <a href="../views/article_views.php" class="btn btn-warning ">Quay lại</a>
                    </div>
                </form>
            </div>
        </div>

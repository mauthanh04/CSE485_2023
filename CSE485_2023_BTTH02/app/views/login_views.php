...
<?php require_once("../controllers/login_controllers.php") ?>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="./login_views.php">Đăng nhập</a>
                    </li>
                </ul>

                <!-- gộp file seaech  -->
                <?php require_once('../controllers/search_login_controllers.php'); ?>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="d-flex justify-content-center h-100">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="login_views.php" method="post">
